OBJ = main.o InvControl.o Store.o Product.o UI.o ProdArray.o CustArray.o Customer.o Purchase.o PurchaseArray.o ProdList.o OrderServer.o OrderArray.o Order.o
